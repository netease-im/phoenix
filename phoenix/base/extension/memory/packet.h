...
// Date: 2011/6/8
//
// Modified by HarrisonFeng <harrisonfeng@corp.netease.com>
// Date: 2015/2/1
//
// This file defined Pack and Unpack class

#ifndef __EXTENSION_MEMORY_PACKET_H__
#define __EXTENSION_MEMORY_PACKET_H__
...
#include "extension/nexeption/error.h"
#include "extension//memory/blockbuffer.h"
#include "extension/macros.h"
...
// PackBuffer -----------------------------------------------------
class EXTENSION_EXPORT PackBuffer
{
public:
...
public:
      ...
      std::string pop_uint64_as_str() const
      {
          ...
          return NS_EXTENSION::StringPrintf(UINT64_FORMAT,value);
      }
...
struct EXTENSION_EXPORT Marshallable
{
...
struct EXTENSION_EXPORT Voidmable : public NS_EXTENSION::Marshallable
{
	virtual void marshal(Pack &p) const {}
	virtual void unmarshal(const Unpack &up) {}
};

struct EXTENSION_EXPORT Mulmable : public NS_EXTENSION::Marshallable
{
	Mulmable(const NS_EXTENSION::Marshallable &m1, const NS_EXTENSION::Marshallable &m2)
		: mm1(m1), mm2(m2) 
	{}
	...
	const NS_EXTENSION::Marshallable &mm1;
	const NS_EXTENSION::Marshallable &mm2;

private:
	Mulmable& operator=(const Mulmable &) = default;
};

struct EXTENSION_EXPORT Mulumable : public NS_EXTENSION::Marshallable
{
    Mulumable(NS_EXTENSION::Marshallable &m1, NS_EXTENSION::Marshallable &m2)
        : mm1(m1), mm2(m2)
	{}
	...
	NS_EXTENSION::Marshallable &mm1;
	NS_EXTENSION::Marshallable &mm2;

private:
	Mulumable& operator=(const Mulumable &) = default;
};

struct EXTENSION_EXPORT Rawmable : public NS_EXTENSION::Marshallable
{
...
#endif // __EXTENSION_MEMORY_PACKET_H__
