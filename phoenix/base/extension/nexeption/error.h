...
#ifndef BASE_EXTENSION_ERROR_H_
#define BASE_EXTENSION_ERROR_H_
...
class EXTENSION_EXPORT NException : public std::runtime_error
{
public:
    NException(const std::string &e) : std::runtime_error(e), error_code_(NS_EXTENSION::kResultFailed) {}
    NException(const char *s, uint32_t error_code = NS_EXTENSION::kResultFailed) 
		: std::runtime_error(s), error_code_(error_code) 
	{}
    NException() 
		: std::runtime_error((const char *)"Unknown error"), error_code_(NS_EXTENSION::kResultFailed)
	{}
