...
class BASE_EXPORT MessageLoopCurrent {
 public:
  ...
  // immediately.
  void AddDestructionObserver(base::MessageLoop::DestructionObserver* destruction_observer);

  // Remove a DestructionObserver.  It is safe to call this method while a
  // DestructionObserver is receiving a notification callback.
  void RemoveDestructionObserver(base::MessageLoop::DestructionObserver* destruction_observer);
 ...
 protected:
  ...
  MessageLoop* ToMessageLoopBaseDeprecated() const { return current_; }
