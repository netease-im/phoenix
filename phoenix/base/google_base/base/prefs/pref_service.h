...
class BASE_PREFS_EXPORT PrefService : public base::NonThreadSafe {
 public:
  ...
  // Returns a dictionary with effective preference values.
    base::scoped_ptr<base::DictionaryValue> GetPreferenceValues() const;

  // Returns a dictionary with effective preference values, omitting prefs that
  // are at their default values.
    base::scoped_ptr<base::DictionaryValue> GetPreferenceValuesOmitDefaults() const;
  ...
  // like this:
  //   {"foo.bar": {"a": {"b": true}}}.
    base::scoped_ptr<base::DictionaryValue> GetPreferenceValuesWithoutPathExpansion()
      const;
 ...
 protected:
  ...
  // unit testing.
    base::scoped_ptr<PrefNotifierImpl> pref_notifier_;
  ...
  // this PrefService. Subclasses may access it for unit testing.
    base::scoped_ptr<PrefValueStore> pref_value_store_;
