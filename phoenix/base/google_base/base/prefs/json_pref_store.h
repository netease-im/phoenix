 ...
 public:
  ...
  JsonPrefStore(
      ...
      const scoped_refptr<base::SequencedTaskRunner>& sequenced_task_runner,
                base::scoped_ptr<PrefFilter> pref_filter);
 ...
 private:
  ...
  class BASE_PREFS_EXPORT WriteCountHistogram {
   public:
    ...
    WriteCountHistogram(const base::TimeDelta& commit_interval,
                        const base::FilePath& path,
                        base::scoped_ptr<base::Clock> clock);
    ~WriteCountHistogram();
   ...
   private:
    ...
    // Clock which is used to retrieve the current time.
      base::scoped_ptr<base::Clock> clock_;
  ...
  // is invoked directly.
          void OnFileRead(base::scoped_ptr<ReadResult> read_result);
  ...
  void FinalizeFileRead(bool initialization_successful,
                        base::scoped_ptr<base::DictionaryValue> prefs,
                        bool schedule_write);
  ...
  const scoped_refptr<base::SequencedTaskRunner> sequenced_task_runner_;
          ...
          base::scoped_ptr<base::DictionaryValue> prefs_;
  ...
  base::ImportantFileWriter writer_;
          ...
          base::scoped_ptr<PrefFilter> pref_filter_;
  base::ObserverList<PrefStore::Observer, true> observers_;

          base::scoped_ptr<ReadErrorDelegate> error_delegate_;
