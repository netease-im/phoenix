...
NET_EXPORT extern const char kHexCharLookup[0x10];
...
NET_EXPORT bool ReadUTFChar(const char* str, int* begin, int length,
...
NET_EXPORT bool ReadUTFChar(const base::char16* str, int* begin, int length,
                            unsigned* code_point_out);
...
// normal.
NET_EXPORT bool ConvertUTF16ToUTF8(const base::char16* input, int input_len,
                                   CanonOutput* output);
NET_EXPORT bool ConvertUTF8ToUTF16(const char* input, int input_len,
                                   CanonOutputT<base::char16>* output);
...
NET_EXPORT int _itoa_s(int value, char* buffer, size_t size_in_chars,
                       int radix);
NET_EXPORT int _itow_s(int value, base::char16* buffer, size_t size_in_chars,
                       int radix);
