...
NET_EXPORT void ParseStandardURL(const char* url,
                                 int url_len,
                                 Parsed* parsed);
NET_EXPORT void ParseStandardURL(const base::char16* url,
                                 int url_len,
                                 Parsed* parsed);
...
NET_EXPORT void ParsePathURL(const char* url,
                             int url_len,
                             bool trim_path_end,
                             Parsed* parsed);
NET_EXPORT void ParsePathURL(const base::char16* url,
                             int url_len,
                             bool trim_path_end,
                             Parsed* parsed);
...
// these.
NET_EXPORT void ParseFileURL(const char* url, int url_len, Parsed* parsed);
NET_EXPORT void ParseFileURL(const base::char16* url,
                             int url_len,
                             Parsed* parsed);

// Filesystem URLs are structured differently than other URLs.
NET_EXPORT void ParseFileSystemURL(const char* url,
                                   int url_len,
                                   Parsed* parsed);
NET_EXPORT void ParseFileSystemURL(const base::char16* url,
                                   int url_len,
                                   Parsed* parsed);

// MailtoURL is for mailto: urls. They are made up scheme,path,query
NET_EXPORT void ParseMailtoURL(const char* url, int url_len, Parsed* parsed);
NET_EXPORT void ParseMailtoURL(const base::char16* url,
                               int url_len,
                               Parsed* parsed);
...
NET_EXPORT bool ExtractScheme(const char* url,
                              int url_len,
                              Component* scheme);
NET_EXPORT bool ExtractScheme(const base::char16* url,
                              int url_len,
                              Component* scheme);

// Returns true if ch is a character that terminates the authority segment
// of a URL.
NET_EXPORT bool IsAuthorityTerminator(base::char16 ch);

// Does a best effort parse of input |spec|, in range |auth|. If a particular
// component is not found, it will be set to invalid.
NET_EXPORT void ParseAuthority(const char* spec,
                               const Component& auth,
                               Component* username,
                               Component* password,
                               Component* hostname,
                               Component* port_num);
NET_EXPORT void ParseAuthority(const base::char16* spec,
                               const Component& auth,
                               Component* username,
                               Component* password,
                               Component* hostname,
...
NET_EXPORT int ParsePort(const char* url, const Component& port);
NET_EXPORT int ParsePort(const base::char16* url, const Component& port);
...
//
// The 8-bit version requires UTF-8 encoding.
NET_EXPORT void ExtractFileName(const char* url,
                                const Component& path,
                                Component* file_name);
NET_EXPORT void ExtractFileName(const base::char16* url,
                                const Component& path,
                                Component* file_name);
...
// return false.
NET_EXPORT bool ExtractQueryKeyValue(const char* url,
                                     Component* query,
                                     Component* key,
                                     Component* value);
NET_EXPORT bool ExtractQueryKeyValue(const base::char16* url,
                                     Component* query,
                                     Component* key,
                                     Component* value);
