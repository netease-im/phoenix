...
NET_EXPORT void AppendIPv4Address(const unsigned char address[4],
                                  CanonOutput* output);

// Writes the given IPv6 address to |output|.
NET_EXPORT void AppendIPv6Address(const unsigned char address[16],
                                  CanonOutput* output);
...
NET_EXPORT bool FindIPv4Components(const char* spec,
                                   const Component& host,
                                   Component components[4]);
NET_EXPORT bool FindIPv4Components(const base::char16* spec,
                                   const Component& host,
                                   Component components[4]);
...
NET_EXPORT CanonHostInfo::Family IPv4AddressToNumber(const char* spec,
                                                     const Component& host,
                                                     unsigned char address[4],
                                                     int* num_ipv4_components);
NET_EXPORT CanonHostInfo::Family IPv4AddressToNumber(const base::char16* spec,
                                                     const Component& host,
                                                     unsigned char address[4],
                                                     int* num_ipv4_components);
...
// i.e. "[::1]" rather than "::1".
NET_EXPORT bool IPv6AddressToNumber(const char* spec,
                                    const Component& host,
                                    unsigned char address[16]);
NET_EXPORT bool IPv6AddressToNumber(const base::char16* spec,
                                    const Component& host,
                                    unsigned char address[16]);
