...
struct NET_EXPORT SchemeWithType {
  const char* scheme;
  SchemeType type;
};
...
NET_EXPORT void AddStandardScheme(const char* new_scheme,
...
NET_EXPORT void LockStandardSchemes();
...
NET_EXPORT bool FindAndCompareScheme(const char* str,
                                     int str_len,
                                     const char* compare,
                                     Component* found_scheme);
NET_EXPORT bool FindAndCompareScheme(const base::char16* str,
                                     int str_len,
                                     const char* compare,
                                     Component* found_scheme);
...
NET_EXPORT bool IsStandard(const char* spec, const Component& scheme);
NET_EXPORT bool IsStandard(const base::char16* spec, const Component& scheme);
...
NET_EXPORT bool GetStandardSchemeType(const char* spec,
...
NET_EXPORT bool Canonicalize(const char* spec,
                             int spec_len,
                             bool trim_path_end,
                             CharsetConverter* charset_converter,
                             CanonOutput* output,
                             Parsed* output_parsed);
NET_EXPORT bool Canonicalize(const base::char16* spec,
                             int spec_len,
                             bool trim_path_end,
                             CharsetConverter* charset_converter,
                             CanonOutput* output,
...
// a valid URL.
NET_EXPORT bool ResolveRelative(const char* base_spec,
                                int base_spec_len,
...
NET_EXPORT bool ReplaceComponents(const char* spec,
                                  int spec_len,
                                  const Parsed& parsed,
                                  ...
                                  CanonOutput* output,
                                  Parsed* out_parsed);
NET_EXPORT bool ReplaceComponents(
    const char* spec,
    int spec_len,
    const Parsed& parsed,
...
NET_EXPORT void DecodeURLEscapeSequences(const char* input,
                                         int length,
                                         CanonOutputW* output);

// Escapes the given string as defined by the JS method encodeURIComponent. See
// https://developer.mozilla.org/en/JavaScript/Reference/Global_Objects/encodeURIComponent
NET_EXPORT void EncodeURIComponent(const char* input,
                                   int length,
                                   CanonOutput* output);
