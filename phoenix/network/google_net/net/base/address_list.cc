...
//namespace {
//
//base::scoped_ptr<base::Value> NetLogAddressListCallback(
//    const AddressList* address_list,
//    NetLogCaptureMode capture_mode) {
//    base::scoped_ptr<base::DictionaryValue> dict(new base::DictionaryValue());
//    base::scoped_ptr<base::ListValue> list(new base::ListValue());
//
