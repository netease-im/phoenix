...
#ifndef NETWORK_BASE_NETWORK_INTERFACES_H_
#define NETWORK_BASE_NETWORK_INTERFACES_H_
...
NET_EXPORT int NetStartup();
NET_EXPORT int NetCleanup();
...
NET_EXPORT base::scoped_ptr<ScopedWifiOptions> SetWifiOptions(int options);

}  // namespace net

#endif  // NETWORK_BASE_NETWORK_INTERFACES_H_
