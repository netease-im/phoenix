#ifndef __BASE_DB_SQLITE3_H__
#define __BASE_DB_SQLITE3_H__

#ifndef SQLITE_HAS_CODEC
#define SQLITE_HAS_CODEC
#endif // SQLITE_HAS_CODEC

#include "nim_db/db_export.h"
#include "nim_db/build/build_config.h"
#include <string>
...
public:
	...
	int            BindText(int index, const char* data, size_t size_in_bytes);
...
public:
    ...
    /*
        ...
        *  Remark      SQLite command：http://www.sqlite.org/lang.html
