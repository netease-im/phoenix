...
// Modified by HarrisonFeng
// Date: 2010/5/18
//
// SQLite Database

#include "nim_db/db_sqlite3.h"
#include <assert.h>
...
int SQLiteStatement::BindText(int index, const char* data, size_t size_in_bytes)
{
	return BindText(index, data, (int) size_in_bytes);
}
